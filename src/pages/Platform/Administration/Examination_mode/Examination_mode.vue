<template>
  <el-main class="SmallBox">
    <div v-show="modular_1">
      ...
      <div class="button_box"><el-button type="primary" size="small" @click="clickExamination()">开始考试</el-button></div>
    </div>
    <div v-show="modular_2" class="Answer_sheet">
      ...
      <div class="Answer_crad">
        ...
        <div class="set_up clear">
          ...
          <el-button type="success" @click="clickSetUp(caseData.id)">收卷</el-button>
        </div>
      </div>
    </div>
  </el-main>
