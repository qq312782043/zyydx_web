<template>
  <el-main class="Classrooms">
    <div v-show="modular_1">
      ...
      <div class="button_box"><el-button type="primary" @click="onExamination()">开始考试</el-button></div>
    </div>
    <div v-show="modular_2" class="Answer_sheet">
      ...
      <div class="Answer_crad">
        ...
        <div class="set_up">
          ...
          <el-button type="success" @click="onSetUp()">设置新的练习范围</el-button>
        </div>
      </div>
    </div>
  </el-main>
